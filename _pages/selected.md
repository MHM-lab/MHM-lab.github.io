...
<br>
<br>
In general, we support open science and believe that publication fees should be proportional to the real value created. At the same time, we recognise that journal prestige still plays a major role especially in early-career trajectories. To support our young researchers, we also publish in high-impact venues, while encouraging efforts to disentangle scientific quality, visibility, and prestige from the need to pay high publication fees.
<br>
<br>
