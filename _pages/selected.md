...
* SUMMARY: We created a large, multi-center benchmark for deep unsupervised anomaly detection in brain imaging based on state-of-art methods developed for brain science and industry, using about 3.000 healthy scans and more than 400.000 slices for training. Our systematic evaluation across scanners, lesion types, and demographics reveals substantial performance variability and highlights key methodological limitations that future algorithms must overcome.
