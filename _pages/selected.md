...
<br>
<br>
Because our work is highly interdisciplinary, it cannot always be classified from the perspective of a single field. For orientation: From 2023 untill 2025, we publish in leading machine-learning and artificial-intelligence conferences (e.g., AAAI), top medical machine-learning venues (e.g., MICCAI), major medical and psychiatry journals (e.g., JAMA Psychiatry), high-impact general-science journals (e.g., Nature family), respected philosophy journals (e.g., Synthese), and core neuroscience outlets (e.g.,eLife).
<br>
<br>
Publishing in these venues demands both depth and breadth. This profile is intentional as we work at the intersections where new insights emerge, and we train our students accordingly. If our work is sometimes difficult to “place,” that is by design, our aim is to integrate fields to generate science that ultimately benefits individual patients.
